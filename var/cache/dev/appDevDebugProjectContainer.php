...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'capture_command_handler' => 'getCaptureCommandHandlerService',
            'check_fraud_command_handler' => 'getCheckFraudCommandHandlerService',
            ...
            'import_order_command_handler' => 'getImportOrderCommandHandlerService',
            ...
            'ship_command_handler' => 'getShipCommandHandlerService',
            ...
            'source_command_handler' => 'getSourceCommandHandlerService',
            ...
            'trigger_capture_command_handler' => 'getTriggerCaptureCommandHandlerService',
            'trigger_fraud_command_handler' => 'getTriggerFraudCommandHandlerService',
            'trigger_shipment_command_handler' => 'getTriggerShipmentCommandHandlerService',
            'trigger_source_command_handler' => 'getTriggerSourceCommandHandlerService',
            'twig' => 'getTwigService',
    ...
    /**
     * Gets the 'capture_command_handler' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Payments\Message\Handler\Capture A Payments\Message\Handler\Capture instance.
     */
    protected function getCaptureCommandHandlerService()
    {
        return $this->services['capture_command_handler'] = new \Payments\Message\Handler\Capture($this->get('event_bus'));
    }

    /**
     * Gets the 'check_fraud_command_handler' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Payments\Message\Handler\CheckFraud A Payments\Message\Handler\CheckFraud instance.
     */
    protected function getCheckFraudCommandHandlerService()
    {
        return $this->services['check_fraud_command_handler'] = new \Payments\Message\Handler\CheckFraud($this->get('event_bus'));
    }
    ...
    protected function getCommandBusService()
    {
        ...
        $instance->appendMiddleware(new \SimpleBus\Message\Handler\DelegatesToMessageHandlerMiddleware(new \SimpleBus\Message\Handler\Resolver\NameBasedMessageHandlerResolver($this->get('simple_bus.command_bus.command_name_resolver'), new \SimpleBus\Message\CallableResolver\CallableMap(array('import_order' => 'import_order_command_handler', 'check_fraud' => 'check_fraud_command_handler', 'capture' => 'capture_command_handler', 'source' => 'source_command_handler', 'ship' => 'ship_command_handler'), new \SimpleBus\Message\CallableResolver\ServiceLocatorAwareCallableResolver(array(0 => $this, 1 => 'get'))))));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_57849cea67215167e258556ebad7d218e059e04c28785635c53777c6906dee06');
    ...
    protected function getEventBusService()
    {
        ...
        $instance->appendMiddleware(new \SimpleBus\Message\Bus\Middleware\FinishesHandlingMessageBeforeHandlingNext());
        $instance->appendMiddleware(new \SimpleBus\Message\Subscriber\NotifiesMessageSubscribersMiddleware(new \SimpleBus\Message\Subscriber\Resolver\NameBasedMessageSubscriberResolver($this->get('simple_bus.event_bus.event_name_resolver'), new \SimpleBus\Message\CallableResolver\CallableCollection(array('captured' => array(0 => 'trigger_fraud_command_handler', 1 => 'trigger_shipment_command_handler'), 'order_imported' => array(0 => 'trigger_capture_command_handler'), 'none' => array(0 => 'trigger_source_command_handler')), new \SimpleBus\Message\CallableResolver\ServiceLocatorAwareCallableResolver(array(0 => $this, 1 => 'get')))), NULL, NULL));
    ...
    /**
     * Gets the 'import_order_command_handler' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Sales\Message\Handler\ImportOrder A Sales\Message\Handler\ImportOrder instance.
     */
    protected function getImportOrderCommandHandlerService()
    {
        return $this->services['import_order_command_handler'] = new \Sales\Message\Handler\ImportOrder($this->get('event_bus'));
    }
    ...
    /**
     * Gets the 'ship_command_handler' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Logistics\Message\Handler\Ship A Logistics\Message\Handler\Ship instance.
     */
    protected function getShipCommandHandlerService()
    {
        return $this->services['ship_command_handler'] = new \Logistics\Message\Handler\Ship($this->get('event_bus'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \SimpleBus\Message\Name\NamedMessageNameResolver A SimpleBus\Message\Name\NamedMessageNameResolver instance.
     */
    protected function getSimpleBus_CommandBus_CommandNameResolverService()
    {
        return $this->services['simple_bus.command_bus.command_name_resolver'] = new \SimpleBus\Message\Name\NamedMessageNameResolver();
    }
    ...
    {
        return $this->services['simple_bus.event_bus.event_name_resolver'] = new \SimpleBus\Message\Name\NamedMessageNameResolver();
    }

    /**
     * Gets the 'source_command_handler' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Inventory\Message\Handler\Source A Inventory\Message\Handler\Source instance.
     */
    protected function getSourceCommandHandlerService()
    {
        return $this->services['source_command_handler'] = new \Inventory\Message\Handler\Source($this->get('event_bus'));
    }
    ...
    /**
     * Gets the 'trigger_capture_command_handler' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Payments\Message\Subscriber\TriggerCapture A Payments\Message\Subscriber\TriggerCapture instance.
     */
    protected function getTriggerCaptureCommandHandlerService()
    {
        return $this->services['trigger_capture_command_handler'] = new \Payments\Message\Subscriber\TriggerCapture($this->get('command_bus'));
    }

    /**
     * Gets the 'trigger_fraud_command_handler' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Payments\Message\Subscriber\TriggerFraud A Payments\Message\Subscriber\TriggerFraud instance.
     */
    protected function getTriggerFraudCommandHandlerService()
    {
        return $this->services['trigger_fraud_command_handler'] = new \Payments\Message\Subscriber\TriggerFraud($this->get('command_bus'));
    }

    /**
     * Gets the 'trigger_shipment_command_handler' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Logistics\Message\Subscriber\TriggerShipment A Logistics\Message\Subscriber\TriggerShipment instance.
     */
    protected function getTriggerShipmentCommandHandlerService()
    {
        return $this->services['trigger_shipment_command_handler'] = new \Logistics\Message\Subscriber\TriggerShipment($this->get('command_bus'));
    }

    /**
     * Gets the 'trigger_source_command_handler' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Inventory\Message\Subscriber\TriggerSourcing A Inventory\Message\Subscriber\TriggerSourcing instance.
     */
    protected function getTriggerSourceCommandHandlerService()
    {
        return $this->services['trigger_source_command_handler'] = new \Inventory\Message\Subscriber\TriggerSourcing($this->get('command_bus'));
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('943093ce95bdb25a5ae4f2e2dfd2e8ce70ee77bb');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56e962d4e80933.07454398')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => '943093ce95bdb25a5ae4f2e2dfd2e8ce70ee77bb',
            'captureattheend' => false,
            'captureatthestart' => true,
            'skipsourcing' => true,
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '943093ce95bdb25a5ae4f2e2dfd2e8ce70ee77bb',
